...
export const metadata = {
  ...
  description:
    "Explore our comprehensive project management services at FINDEB, encompassing project framing, engineering coordination, health, safety & environment management, quality assurance, project support, and cost engineering & control. From meticulous project plans and engineering integration to safety management, quality assurance, and financial control, our expert services ensure successful project realization.",
  keywords:
